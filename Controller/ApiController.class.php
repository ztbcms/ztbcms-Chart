...
class ApiController extends Controller {
    ...
    protected function getData($chart, $focusUpdate = false) {
        ...
        //设置 Y 轴数据
        $y_data = ChartService::getY($chart['table'], $chart['time_field'], $chart['time_section'], $chart['x'], $chart['x_type'], $chart['y'], $chart['y_type'], $chart['filter'], $chart['order'], $chart['show_all']);
